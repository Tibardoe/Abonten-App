...
// Cloudinary-first, DB-second ordering (matches deleteEventDraft.ts) — a
// failed Cloudinary destroy leaves the draft row in place so the asset can
// still be found and retried, instead of orphaning it silently.
