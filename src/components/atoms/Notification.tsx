    ...
    <AnimatePresence>
      {notification && (
        <motion.div
          ...
          className="fixed bottom-24 md:bottom-10 right-[5%] z-30 md:right-[10%] bg-popover text-popover-foreground border border-border p-4 rounded-lg shadow-lg flex items-center justify-center w-80"
        >
