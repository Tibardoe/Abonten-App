...
// the purchased thing (ticket / subscription / promotion) — the moment
// right before the page's own server-rendered "purchase complete" state
// takes over. Never say "ticket" for a purchase that isn't one.
const FULFILLMENT_MESSAGE: Record<CheckoutKind, string> = {
  ticket: "Payment successful. Preparing your ticket…",
  subscription: "Payment successful. Activating your subscription…",
