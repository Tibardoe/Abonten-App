...
- Support hours and reply goals were decided and published on 2026-09-12 (decision O1 — `../operations/support-operating-policy.md`): Monday–Friday 09:00–17:00 Ghana time, two-working-day goals. Still missing: the escalation procedure (decision O7) and counsel-approved safe-harbour wording for the responsible-disclosure section (legal D3). The section and `/.well-known/security.txt` exist since 2026-09-12 and are production-verified.
...
| Support hours and response target published | **Done 2026-09-12** — Monday–Friday 09:00–17:00 Ghana time; two-working-day goals (decision O1); escalation procedure still open (O7) |
...
**Status: channels, hours and reply goals published. Remaining work (O7 escalation procedure; D3 safe-harbour wording) is gated on those decisions; nothing further is to be invented.**
