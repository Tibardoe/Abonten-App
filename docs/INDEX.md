...
|---|---|---|
| Admin Handbook | [admin/README.md](admin/README.md) | one page per console module; [admin/metrics.md](admin/metrics.md) (what every figure means) · [admin/support-scenarios.md](admin/support-scenarios.md) |
...
| Search finds nothing / "why did I get this notice?" / too many recommendation pushes | [admin/discovery.md](admin/discovery.md) · [architecture/discovery-search-and-recommendations.md](architecture/discovery-search-and-recommendations.md) · [troubleshooting/README.md](troubleshooting/README.md) |
| A Spotlight or Story is missing, a creator cannot post, or a promotion is stuck or needs a refund | [admin/spotlight.md](admin/spotlight.md) · [architecture/spotlight-and-stories.md](architecture/spotlight-and-stories.md) |
| App shows nothing offline / Spotlight video frozen or wrong audio / comments not updating / search finds nothing for a dish or a month | [architecture/mobile-offline-media-and-sync.md](architecture/mobile-offline-media-and-sync.md) |
| Abonten Weekly edition did not publish / a listing vanished from an edition | [admin/weekly.md](admin/weekly.md) · [architecture/weekly-highlights.md](architecture/weekly-highlights.md) |
| Opening a new country / a market will not activate / prices in the wrong currency / wrong event time abroad | [admin/markets.md](admin/markets.md) · [architecture/global-platform.md](architecture/global-platform.md) |
...
- **admin/** — [README](admin/README.md) · [dashboard](admin/dashboard.md) · [metrics](admin/metrics.md) · [users](admin/users.md) · [reports-and-moderation](admin/reports-and-moderation.md) · [content](admin/content.md) · [claims](admin/claims.md) · [verification](admin/verification.md) · [discovery](admin/discovery.md) · [spotlight](admin/spotlight.md) · [weekly](admin/weekly.md) · [markets](admin/markets.md) · [catalog](admin/catalog.md) · [finance](admin/finance.md) · [rewards](admin/rewards.md) · [field-ops](admin/field-ops.md) · [notifications](admin/notifications.md) · [monitoring-and-incidents](admin/monitoring-and-incidents.md) · [analytics](admin/analytics.md) · [audit-logs](admin/audit-logs.md) · [settings-and-rbac](admin/settings-and-rbac.md) · [support](admin/support.md) · [support-scenarios](admin/support-scenarios.md)
...
- **architecture/** — [README](architecture/README.md) · [system-overview](architecture/system-overview.md) · [feature-inventory](architecture/feature-inventory.md) · [roles-and-permissions](architecture/roles-and-permissions.md) · [data-model-overview](architecture/data-model-overview.md) · [integrations](architecture/integrations.md) · [observability](architecture/observability.md) · [shared-backend](architecture/shared-backend.md) · [rewards-ledger](architecture/rewards-ledger.md) · [trust-and-verification](architecture/trust-and-verification.md) · [discovery-search-and-recommendations](architecture/discovery-search-and-recommendations.md) · [weekly-highlights](architecture/weekly-highlights.md) · [spotlight-and-stories](architecture/spotlight-and-stories.md) · [reviews-and-account-setup](architecture/reviews-and-account-setup.md) · [global-platform](architecture/global-platform.md) · [mobile-offline-media-and-sync](architecture/mobile-offline-media-and-sync.md) · [perf/discovery-2026-09](architecture/perf/discovery-2026-09.md) · [perf/promotion-delivery-2026-09](architecture/perf/promotion-delivery-2026-09.md) · [field-ops](architecture/field-ops.md) · [email-auth](architecture/email-auth.md)
...
- **audit/** — [00-system-map](audit/00-system-map.md) · [01-limitations-register](audit/01-limitations-register.md) · [02-remediation-roadmap](audit/02-remediation-roadmap.md) (2026-09-04 snapshot) · [03-holistic-audit-2026-09-13](audit/03-holistic-audit-2026-09-13.md) (whole-platform audit: findings, what shipped, what is deferred, health assessment) · [04-holistic-audit-2026-09-18](audit/04-holistic-audit-2026-09-18.md) (production-readiness audit: webhook acknowledgement, one mobile keyboard architecture, database indexes, verification record) · [05-holistic-audit-2026-09-19](audit/05-holistic-audit-2026-09-19.md) (enterprise hardening pass: outbound deadlines, typed data layer, CSP, explicit route protection, boot-time configuration check, accessible colour tokens, browser test suite, admin action modules, structured logs) · [06-expo-dependency-migration-2026-09-19](audit/06-expo-dependency-migration-2026-09-19.md) (why the mobile app stays on Expo SDK 57, the decode-uri-component advisory resolved without a dependency override, and the verified Android release candidate) · [07-full-system-audit-2026-09-25](audit/07-full-system-audit-2026-09-25.md) (adversarial full-system audit: payment attempts bound to one charge, Data API column/row guards, provider variable allowlist, OTP ceilings, door check-in race, money formatting per currency, accessibility; rollout order for its nine migrations) · [08-production-gate-2026-09-25](audit/08-production-gate-2026-09-25.md) (go/no-go verification: the live event-creation defect the deployment fixes, staff Data API powers, atomic phone-code limits, geocoding budget, per-query market visibility, deployment rehearsal A–D, load at 10/50/100, iOS release-risk list, rollout sequence) · [09-incident-recovery-and-release-gate-2026-09-25](audit/09-incident-recovery-and-release-gate-2026-09-25.md) (the event-creation and organizer-dashboard incidents: cause, timeline, impact; fixes F1–F7; production smoke and Android verification; iOS App Review blockers; production runbook) · [10-live-paystack-cutover-2026-09-25](audit/10-live-paystack-cutover-2026-09-25.md) (Paystack test/live audit, environment separation, lost-settlement sweep, test/live guards, reconciliation against Paystack, the paid-sales gate)
- **changelog/** — [README](changelog/README.md)

## Keywords

payments · Paystack · webhook · refund · service fee · settlement · payout · ledger · reconciliation · dispute · chargeback · ticket · QR · check-in · checkout hold · promo code · promotion · featuring · Spotlight · Stories · follow · sponsored · Abonten Weekly · weekly edition · promoter commission · organizer · place owner · claim · verified · booking · review · highlight · messaging · support conversation · report · moderation · appeal · hidden · removed · restricted · suspend · ban · restore · RBAC · step-up · audit log · Abonten Credit · rewards · referral · invite · loyalty · rebate · shadow mode · field team · onboarding · owner OTP · consent link · commission · sweep · payout batch · notifications · push · Expo · Resend · Hubtel · OTP · Google sign-in · RLS · service role · SECURITY DEFINER · migrations · MCP · Vercel · EAS · Sentry · observability · health check · incident · disaster recovery · backups · kill switch · cookies · cookie consent · `abn_ref` · `abn_did` · age gate · data export · data inventory · retention · deletion · DSAR · Act 843 · Act 772 · Act 1038 · placeholders · TO BE CONFIRMED
