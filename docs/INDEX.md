...
- **audit/** — [00-system-map](audit/00-system-map.md) · [01-limitations-register](audit/01-limitations-register.md) · [02-remediation-roadmap](audit/02-remediation-roadmap.md) (2026-09-04 snapshot) · [03-holistic-audit-2026-09-13](audit/03-holistic-audit-2026-09-13.md) (whole-platform audit: findings, what shipped, what is deferred, health assessment) · [04-holistic-audit-2026-09-18](audit/04-holistic-audit-2026-09-18.md) (production-readiness audit: webhook acknowledgement, one mobile keyboard architecture, database indexes, verification record)
