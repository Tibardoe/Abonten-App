...
How the system works: [README.md](README.md) · Writing rules: [DOCUMENTATION_STANDARD.md](DOCUMENTATION_STANDARD.md) · Registers: [LEGAL_REVIEW_REQUIRED.md](LEGAL_REVIEW_REQUIRED.md), [OPERATIONAL_DECISIONS_REQUIRED.md](OPERATIONAL_DECISIONS_REQUIRED.md) · Gated specifications: [specifications/README.md](specifications/README.md) · Coverage: [documentation-coverage-matrix.md](documentation-coverage-matrix.md) (where each feature is documented), [documentation-audit-matrix.md](documentation-audit-matrix.md) (documented / accurate / gap) · [changelog/README.md](changelog/README.md)
...
| Security Runbook | [security/README.md](security/README.md) | application, database, payment, infrastructure, secrets, access control; leak response in [security/secrets-and-environment.md](security/secrets-and-environment.md) |
| Support Runbook | [operations/account-and-support-procedures.md](operations/account-and-support-procedures.md) | [admin/support.md](admin/support.md) · [admin/support-scenarios.md](admin/support-scenarios.md) · [privacy/privacy-rights-operations.md](privacy/privacy-rights-operations.md) · [operations/what-do-i-do-when.md](operations/what-do-i-do-when.md) |
