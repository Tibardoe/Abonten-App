...
| K1 | Opening Abonten Weekly | Release | Pending — ships switched **off**, audience `staff` | Business (founder) | One Ghana edition published by staff and checked on web and app in production | Before anyone outside staff sees an edition | [../admin/weekly.md](../admin/weekly.md) |
