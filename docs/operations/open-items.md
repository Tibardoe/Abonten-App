...
| S2 | Responsible disclosure and `security.txt` | Security / Legal | Implemented (public section + file, 2026-09-12); **Legal review** of safe-harbour wording; production verification after deploy | Security (founder) / Legal | Counsel-approved wording; `curl` of the live file | No — page states no safe harbour is offered yet | [../security/responsible-disclosure.md](../security/responsible-disclosure.md) |
...
| M1 | Mobile EAS update and device verification of the branch's mobile changes | Release | Pending — SOURCE VERIFIED only; BUILD, DEVICE and PRODUCTION verification pending | Engineering / QA | EAS Update id on the production channel; device test record | Before claiming the mobile changes are live | [../mobile/release-verification.md](../mobile/release-verification.md) |
