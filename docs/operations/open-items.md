...
|---|---|---|---|---|---|---|---|
| O1 | Support days, hours, timezone, response targets, goals-vs-commitments | Operations | **Closed (2026-09-12):** Monday–Friday 09:00–17:00 Ghana time, public holidays excluded; two-working-day reply goal (support, privacy) and acknowledgement goal (security); goals, not commitments. Applied to Terms 1.3-draft, Privacy 1.3-draft, Security 1.3-draft, help pages, handbooks | Business (founder) | Decision recorded in the policy document | — | [support-operating-policy.md](support-operating-policy.md) |
| O7 | Support escalation procedure (who, trigger, how the user is told) | Operations | Decision required | Business (founder) | Recorded escalation path | No (interim internal routing exists) | [support-operating-policy.md](support-operating-policy.md) §1 |
...
| A2 | Data Protection Commission registration | Compliance | **Closed (2026-09-17):** registered — provisional certificate PROV2609522, 16 Sep 2026 to 15 Sep 2028; inserted in Privacy 1.4-draft. Still to do: record the electronic certificate when the Commission issues it; renew before 2028-09-15 | Company (founder) | Commission certificate (sighted 2026-09-17) | No | [../legal/dpc-registration.md](../legal/dpc-registration.md) |
...
| ID | Item | Category | Status | Owner | Evidence required | Blocking? | Detail |
|---|---|---|---|---|---|---|---|
| V1 / H2 | Verification evidence retention periods | Legal / Product | Legal review; decision required | Counsel → founder | Confirmed lawful period recorded | No (ships at 90 / 365 days, changeable by setting) | [../architecture/trust-and-verification.md](../architecture/trust-and-verification.md) §5 |
| V2 | Who reviews verification, and who may revoke | Operations | Decision required | Business (founder) | Role assignment recorded | No (seeded defaults in place) | [../admin/verification.md](../admin/verification.md) |
| V3 | Whether individual and informal organizers may apply | Product | Decision required | Business (founder) | Setting confirmed | No (all three types ship enabled) | [../OPERATIONAL_DECISIONS_REQUIRED.md](../OPERATIONAL_DECISIONS_REQUIRED.md) §Trust and verification |
| V6 | Opening the verification programme | Release | Pending — ships switched **off**, audience `staff` | Business (founder) | One real place verified end to end in production | Before owners can apply at all | [../architecture/trust-and-verification.md](../architecture/trust-and-verification.md) §11 |
| H1 / H3 | Which Ghanaian documents may be requested, and the badge wording | Legal | Legal review | Legal | Counsel's confirmation | Before the programme opens to `all` | [../LEGAL_REVIEW_REQUIRED.md](../LEGAL_REVIEW_REQUIRED.md) §H |
| N1 | Opening Discovery search and recommendation notices | Release | Pending — ships switched **off**; shadow mode on; audiences `staff` | Business (founder) | Shadow exit criteria in `admin/discovery.md` met on staff and beta; legal G3 answered | Before any recommendation push reaches a customer | [../admin/discovery.md](../admin/discovery.md) |
| K1 | Opening Abonten Weekly | Release | Pending — switched **on for staff only** on 2026-09-13; a staff test edition was published and checked on web (desktop and phone width) and in the Android app against production | Business (founder) | The founder decides when to widen the audience to beta or everyone; publish a real edition first | Before anyone outside staff sees an edition | [../admin/weekly.md](../admin/weekly.md) |
| M2 | Mobile device verification of the verification screens | Release | Pending — web and admin verified in a local browser; mobile screens are SOURCE VERIFIED only | Engineering / QA | Signed-in device test record; EAS build and update ids | Before claiming the mobile flow works | [../mobile/release-verification.md](../mobile/release-verification.md) |
