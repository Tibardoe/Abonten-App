...
| Discovery | `discovery.view` | [discovery.md](discovery.md) |
| Spotlight & Stories | `spotlight.view` | [spotlight.md](spotlight.md) |
| Abonten Weekly | `weekly.view` | [weekly.md](weekly.md) |
