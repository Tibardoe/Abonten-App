...
| Claims and verification (documents purged after 30 days) | [Claiming and verifying a place](../apps/web/src/content/help/place-owners/claiming-and-verifying-a-place.md) | [Admin › Claims](admin/claims.md) · [Field ops — claim assistance](field-operations/claim-assistance.md) | [Data retention §1](privacy/data-retention-and-deletion.md) |
