...
The documents in `apps/web/src/content/legal/` are **professional drafts prepared from the codebase, not legal advice**. They describe what the product actually does. Nothing in them claims — and nothing in this repository may claim — that Abonten is legally compliant, certified, licensed or approved, unless that fact has been explicitly verified and recorded here with its evidence (registration with the Data Protection Commission was verified on 2026-09-17 — item A2). This register lists what a qualified reviewer must confirm or decide. Items are grouped by the law or topic they concern; no law beyond those named is asserted to apply.
...
| A2 | Whether the operator must register as a data controller with Ghana's Data Protection Commission (DPC) under the Data Protection Act, 2012 (Act 843), and its registration status | Privacy §1, §11 | Confirm status; register if required; insert reference | **Decided 2026-09-17 — registered.** Provisional Certificate of Registration PROV2609522 (ref. DPC/REG/01/01/522-26), registered 16 Sep 2026, expires 15 Sep 2028; inserted in Privacy §1 (1.4-draft). Follow-ups (electronic certificate, renewal, supervisor question) in [legal/dpc-registration.md](legal/dpc-registration.md) |
...
| ~~`[DPC REGISTRATION STATUS — TO BE CONFIRMED]`~~ | Privacy §1 | **Filled 2026-09-17** from the Commission's provisional certificate: PROV2609522, registered 16 Sep 2026, valid to 15 Sep 2028 | A2 (Decided) |
