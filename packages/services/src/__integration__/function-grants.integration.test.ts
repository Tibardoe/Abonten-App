...
const SERVICE_ROLE_ONLY: Call[] = [
  ...
  },
  {
    name: "create_event",
    args: {
      p_client_request_id: ABSENT_ID,
      p_organizer_id: ABSENT_ID,
      p_title: "x",
      p_slug: "x",
      p_description: "x",
      p_event_code: "x",
    ...
    why: "locked 2026-09-25: it takes owner, country, zone, currency and 'featured' as parameters; the service resolves them",
  },
  {
    name: "create_place",
    args: {
      p_client_request_id: ABSENT_ID,
      p_owner_id: ABSENT_ID,
      p_name: "x",
      p_slug: "x",
      p_description: "x",
      p_category_id: 1,
      ...
      p_whatsapp: null,
      p_social_links: null,
      p_cover_public_id: null,
      p_cover_version: null,
      p_opening_hours: null,
      p_services: null,
      p_country_code: "GH",
      p_timezone: "Africa/Accra",
    },
    why: "locked 2026-09-25: it takes owner, country and zone as parameters; the service resolves them",
  },
  {
    name: "issue_free_ticket",
    args: {
      p_user_id: ABSENT_ID,
      p_event_id: ABSENT_ID,
