// Generated by supabase gen types (via Supabase MCP) on 2026-08-30.
  ...
  public: {
    Tables: {
      ...
      place_report: {
        ...
        Relationships: [
          {
            foreignKeyName: "place_report_place_id_fkey";
            columns: ["place_id"];
            isOneToOne: false;
            referencedRelation: "place";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "place_report_reporter_id_fkey";
            columns: ["reporter_id"];
            isOneToOne: false;
            referencedRelation: "user_info";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "place_report_review_id_fkey";
            columns: ["review_id"];
            isOneToOne: false;
