...
const PROTECTED_PREFIXES = [
  ...
  "/organizer",
  "/settings",
  // Creating a place/event needs a session; the public detail routes
  // (`/place/<id>`, `/event/<id>`) stay open — these prefixes only match
  // the literal `/place/new` and `/event/new`.
  "/place/new",
  "/event/new",
] as const;
