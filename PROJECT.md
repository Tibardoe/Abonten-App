...
**Database**: one general-purpose `notification` table (see §7.2), no RLS, no partitioning — same app-layer-only security model as every other table in this schema.
